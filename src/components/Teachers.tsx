      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white max-w-4xl mx-auto leading-relaxed mb-8">
            ...
            <Button onClick={handleWhatsAppClick} size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-4 px-8 rounded-full text-lg shadow-2xl transform hover:scale-105 transition-all duration-300">QUERO CURSAR TEOLOGIA</Button>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            delay: 2000
              ...
              <CarouselContent>
                {teachers.map((teacher, index) => <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-2">
                      <Card className="bg-gray-900 border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden h-full">
                        <CardContent className="p-0 flex flex-col h-full">
                          ...
                          <div className="p-6 flex-1 flex flex-col">
                            ...
                            <div className="flex-1">
                              <p className="text-blue-200 text-sm leading-relaxed">{teacher.bio}</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
