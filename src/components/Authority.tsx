          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold text-black leading-tight">
                <span className="text-gray-600">28 anos</span> formando líderes através do 
                <span className="text-black"> ensino prático da Palavra</span>
              </h2>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Não é apenas um curso - é uma <strong>jornada de transformação completa</strong>. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
                {stats.map((stat, index) => (
                  <Card key={index} className="border-2 border-black shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            {/* Image placeholder */}
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl h-96 flex items-center justify-center border-2 border-black">
              <div className="text-center text-gray-600">
                <Book className="w-24 h-24 mx-auto mb-4 text-black" />
                <p className="text-lg font-medium">28 anos de excelência</p>
